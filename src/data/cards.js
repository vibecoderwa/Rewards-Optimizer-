...
export const CARDS = [
  ...
  },
  {
    ...
    color: '#7A3848',
    rules: [
      { category: 'dining',     multiplier: 3, unit: 'pct', cap: null, notes: '3% cash back on dining' },
      { category: 'groceries',  multiplier: 3, unit: 'pct', cap: null, notes: '3% on groceries (excluding Walmart + Target)' },
      { category: 'entertainment', multiplier: 3, unit: 'pct', cap: null, notes: '3% on entertainment' },
      { category: 'streaming',  multiplier: 3, unit: 'pct', cap: null, notes: '3% on popular streaming' },
  ...
  },
  {
    ...
    color: '#111111',
    rules: [
      { category: 'rent',     multiplier: 2, unit: 'pts', cap: 100000, notes: '2× Bilt points on rent (no fee, no cap)' },
      { category: 'dining',   multiplier: 5, unit: 'pts', cap: null,   notes: '5× on dining (Obsidian tier)' },
      { category: 'travel',   multiplier: 4, unit: 'pts', cap: null,   notes: '4× on travel (Obsidian tier)' },
      { category: 'default',  multiplier: 2, unit: 'pts', cap: null,   notes: '2× on everything else (Obsidian tier)' },
    ],
