...
export const CARDS = [
  ...
  },
  {
    ...
    color: '#0F1F33',
    rules: [
      { category: 'hotels',  multiplier: 10, unit: 'pts', cap: null, notes: '10× UR on hotels & rental cars via Chase Travel' },
      { category: 'travel',  multiplier: 5,  unit: 'pts', cap: null, notes: '5× UR on flights via Chase Travel' },
      { category: 'flights', multiplier: 5,  unit: 'pts', cap: null, notes: '5× UR on flights via Chase Travel' },
      { category: 'dining',  multiplier: 3,  unit: 'pts', cap: null, notes: '3× UR on dining worldwide' },
      { category: 'default', multiplier: 1,  unit: 'pts', cap: null, notes: '1× UR on everything else' },
    ],
    perks: ['$300/yr travel credit', 'Priority Pass lounge access', '50% boost on UR via portal'],
  },
  {
    ...
    color: '#1F6FB2',
    rules: [
      { category: 'travel',  multiplier: 5,   unit: 'pct', cap: null, notes: '5% on travel via Chase Travel portal' },
      { category: 'dining',  multiplier: 3,   unit: 'pct', cap: null, notes: '3% on dining (incl. takeout & delivery)' },
      { category: 'default', multiplier: 1.5, unit: 'pct', cap: null, notes: '1.5% on everything else' },
    ],
    perks: ['No annual fee', 'Earns Ultimate Rewards if paired with CSP/CSR'],
  },
  {
    id: 'citi-double-cash',
    brand: 'savor',
    ...
    color: '#1A1A1A',
    rules: [
      { category: 'default', multiplier: 2, unit: 'pct', cap: null, notes: '2% on everything (1% buy + 1% pay)' },
    ],
    perks: ['No annual fee', 'Flat-rate workhorse'],
  },
  {
    ...
    color: '#B81F2D',
    rules: [
      { category: 'default', multiplier: 2, unit: 'pct', cap: null, notes: '2% cash rewards on everything' },
    ],
  ...
  },
  {
    ...
    color: '#0F4FA8',
    rules: [
      { category: 'groceries',     multiplier: 6, unit: 'pct', cap: 6000, notes: '6% at US supermarkets (up to $6k/yr)' },
      { category: 'streaming',     multiplier: 6, unit: 'pct', cap: null, notes: '6% on select US streaming subscriptions' },
      { category: 'gas',           multiplier: 3, unit: 'pct', cap: null, notes: '3% at US gas stations' },
      { category: 'transit',       multiplier: 3, unit: 'pct', cap: null, notes: '3% on transit (rideshare, parking, tolls, trains)' },
      { category: 'default',       multiplier: 1, unit: 'pct', cap: null, notes: '1% on everything else' },
    ],
    perks: ['$84/yr Disney bundle credit', 'Cash back as Reward Dollars'],
  },
  {
    ...
    color: '#7A7A7A',
    rules: [
      { category: 'default', multiplier: 1.5, unit: 'pct', cap: null, notes: '1.5% cash back on everything' },
    ],
...
export const POINT_VALUES = {
  ...
  'chase-csp':               0.0175,
  'chase-csr':               0.02,
  'chase-freedom-unlimited': 0.0175,
  'venture-x':               0.0175,
  'savor':                   0.01,
  'bilt-obsidian':           0.021,
  'citi-double-cash':        0.01,
  'wells-fargo-active-cash': 0.01,
  'amex-bcp':                0.01,
  'capital-one-quicksilver': 0.01,
};
